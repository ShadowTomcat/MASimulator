...
public class SynchronousJFXFileChooser {
     ...
     * of the chooser, FileChooser::new could be passed as a factory.
     *
     ...
     * @param <T> the return type of the method, usually File or
     * List&lt;File&gt;
     ...
     * the dialog-showing task (once started, it is allowed to run as long as
     * needed)
    ...
    public File showOpenDialog(Window ownerWindow) {
        return showDialog(chooser -> chooser.showOpenDialog(ownerWindow));
    }
